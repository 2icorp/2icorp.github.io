...
(function (root) {
  const UI = {
    ko: {
      // document
      "doc.title": "LLM 자체 호스팅 계산기 · VRAM·비용·vLLM/SGLang/TensorRT-LLM 서빙 준비도 (docker-compose·K8s 매니페스트)",
      ...
      "footer": "100% 클라이언트 사이드 · <a href=\"mailto:contact@2icorp.site\">2i</a> · MIT · 특정 벤더와 무관한 독립 도구. 수치는 공개 정보 기반 추정치입니다.",
      // dynamic · cost (own)
    ...
    en: {
      ...
      "footer": "100% client-side · <a href=\"mailto:contact@2icorp.site\">2i</a> · MIT · a vendor-independent tool. Figures are estimates from public information.",
